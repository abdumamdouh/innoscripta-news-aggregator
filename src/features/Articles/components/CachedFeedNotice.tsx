...
export interface CachedFeedNoticeProps {
...
/**
 * Says out loud that the stories below are not today's. A stale feed shown silently is the
 ...
 */
export function CachedFeedNotice({ savedAt, actions }: CachedFeedNoticeProps) {
  ...
  return (
    ...
    >
      <span>{t('feed.cached.notice', { when })}</span>
      <AppButton
        size="sm"
        variant="secondary"
        className="ms-auto"
