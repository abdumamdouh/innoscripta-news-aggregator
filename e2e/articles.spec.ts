...
/**
 * The article list, driven as a reader drives it. Every provider is served from a
 * synthetic feed here rather than a captured one, because these assertions are about
 * *which* stories survive a filter — which needs titles, dates and sources we chose.
 *
...
async function mockProviders(target: Page | BrowserContext, blocked: string[] = []) {
